...
public class SimpleButtonBar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdClose = new client.style.Buttont();
        cmdResize = new client.style.Buttont();
        cmdMinimize = new client.style.Buttont();
    ...
    private client.style.Buttont cmdClose;
    private client.style.Buttont cmdMinimize;
    private client.style.Buttont cmdResize;
